    ...
    <div class="container">
        <section>
            ...
            <p>
                ...
                <button class="button button--primary button--sm pr-8">Button</button>
            </p>
            <p>
        ...
        <section>
            <h1>.banner</h1>
            <div class="banner" style="background-image: url('./dist/fond.jpg')"></div>
            <div class="banner banner--text" style="background-image: url('./dist/fond.jpg')">
                <h2 class="banner__content">
        ...
        <section>
            <h1>.grid</h1>
            <div class="grid">
                <div class="col-sm-6 col-md-4 col-lg-2 h-8 bg-red"></div>
                <div class="col-2 h-8 bg-red"></div>
                <div class="col-2 h-8 bg-red"></div>
            </div>
        </section>
        <section>
